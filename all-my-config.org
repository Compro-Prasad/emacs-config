...
#+BEGIN_SRC emacs-lisp -i
;TODO: See which one I really want
...
(setq org-src-fontify-natively t
      ...
      org-export-backends '(ascii org beamer html latex md)
...
** Winner
<2018-06-15 Fri>
For managing window configurations:
#+BEGIN_SRC emacs-lisp -i
(use-package winner
  :init
  (winner-mode 1))
#+END_SRC
- ~C-c <left>~  - undo window config
- ~C-c <right>~ - redo window config
...
** =test-c= - Test single file C/C++ source code
#+BEGIN_SRC emacs-lisp -i
(use-package test-c :ensure t :defer t)
#+END_SRC
...
(use-package company
  ...
  (setq company-idle-delay 0.1
        ...
        company-backends '(company-jedi company-nxml company-cmake
...
** DONE ccls
CLOSED: [2018-05-16 Wed 19:11]
Refer: [[https://github.com/MaskRay/ccls/issues/3#issuecomment-383806278][ccls - GitHub issue]]
#+BEGIN_SRC emacs-lisp -i
(use-package ccls
  :ensure t
...
** TODO Minibuffer editing - more space!
#+BEGIN_SRC emacs-lisp -i
...
#+END_SRC
Source: [[http://pages.sachachua.com/.emacs.d/Sacha.html][Sacha Chua]]
