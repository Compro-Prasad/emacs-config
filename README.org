...
** Arch User Repository
   ...
   yay -S emacs-git
   #+end_src
** Debian stable is not tested on
** Ubuntu and its derivatives
   Master branch of Emacs ([[https://launchpad.net/~ubuntu-elisp/+archive/ubuntu/ppa][Ref]]):
   #+begin_src sh
...
** Tramp
   ...
   Then remove tramp's default control master settings:
   #+begin_src emacs-lisp :tangle init.el
